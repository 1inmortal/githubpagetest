...
export default class GitHubIcon extends Icon3D {
    ...
    async _loadShadersAndInit() {
        ...
        // Logo Octocat (SVG simple como textura)
        ...
        ctx.save();
        ctx.translate(128,128); ctx.scale(7,7);
        ctx.beginPath();
        ctx.moveTo(0, -18);
        ctx.bezierCurveTo(-14, -18, -24, -8, -24, 6);
        ctx.bezierCurveTo(-24, 18, -14, 28, 0, 32);
        ctx.bezierCurveTo(14, 28, 24, 18, 24, 6);
        ctx.bezierCurveTo(24, -8, 14, -18, 0, -18);
        ctx.closePath();
        ctx.fillStyle = '#fff';
    ...
    onClick() {
        ...
        // Aquí puedes agregar lógica para partículas y onda de pulso
    }
    update(delta) {
