...
const bgAudio = new Audio('assets/sounds/background.mp3');
bgAudio.loop = true;
bgAudio.volume = 0.3;
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  // Nota: Muchas veces los navegadores bloquean la reproducción automática.
  ...
  // Agregar sonido de clic a botones y enlaces
  document.querySelectorAll('button, a').forEach((element) => {
    element.addEventListener('click', () => {
      // Reinicia el audio para que suene cada vez que hay click
  ...
  if (containerWebGL) {
    ...
    window.addEventListener('resize', () => {
      camera.aspect = containerWebGL.clientWidth / containerWebGL.clientHeight;
...
// Ejemplo de uso: generarMasTarjetas(5);
