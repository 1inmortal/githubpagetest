        ...
        // Exponer globalmente para que React pueda llamarlo
        window.initApp = function() {
            ...
            // Ejecutar animaciones iniciales inmediatamente
            initLoaderAndHero();
                ...
                card.innerHTML = `
                    <div class="dish-card-inner">
                        <div class="dish-image-wrapper">
                            <img src="${item.img}" alt="${item.name}" loading="lazy" width="800" height="450">
                        </div>
        ...
        function initCustomCursor() {
            ...
            // Hacer visibles los cursores al inicio
            ...
            // Actualizar posición con mousemove
            ...
            // Asegurar que el cursor se muestre al entrar en la ventana
            window.addEventListener('mouseenter', () => {
                gsap.to([cursorDot, cursorCircle], { autoAlpha: 1, duration: 0.3 });
            });
            
            // Ocultar cuando sale de la ventana
            window.addEventListener('mouseleave', () => {
                gsap.to([cursorDot, cursorCircle], { autoAlpha: 0, duration: 0.3 });
            });
            ...
            // Reinicializar si la página se vuelve visible
