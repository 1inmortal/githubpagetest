#!/usr/bin/env python3
"""
Script de entrenamiento para el modelo VisDrone
...
def setup_training_environment():
    ...
    print("🚀 Configurando entorno de entrenamiento VisDrone...")
    ...
    os.makedirs("runs/detect/visdrone", exist_ok=True)
    os.makedirs("results/visdrone", exist_ok=True)
...
def train_visdrone_model(config_path, epochs=100, imgsz=640, batch=16, device=0, workers=8):
    """
    Entrena el modelo VisDrone
    ...
    print("🎯 Iniciando entrenamiento del modelo VisDrone...")
    ...
    try:
        ...
        print(f"📁 Resultados guardados en: runs/detect/visdrone")
        
        # Guardar el mejor modelo
        best_model_path = "runs/detect/visdrone/weights/best.pt"
        if os.path.exists(best_model_path):
            import shutil
            shutil.copy2(best_model_path, "models/visdrone_yolov8.pt")
            print(f"💾 Mejor modelo guardado como: models/visdrone_yolov8.pt")
...
def main():
    """Función principal"""
    parser = argparse.ArgumentParser(description='Entrenar modelo VisDrone para análisis urbano')
    parser.add_argument('--config', type=str, default='../configs/visdrone.yaml',
    ...
    print("=" * 60)
    print("🎯 ENTRENAMIENTO DEL MODELO VISDRONE")
    print("   Análisis Urbano General - Detección de Objetos")
    print("=" * 60)
    ...
    if args.validate:
        model_path = "runs/detect/visdrone/weights/best.pt"
